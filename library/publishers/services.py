...
def get_publisher(repo: AbstractRepository, name: str):
    return repo.get_publisher(name)


def get_nth_books_by_publisher_page(repo: AbstractRepository, name: str, page: int):
...
def get_books_by_publisher_page_count(repo: AbstractRepository, name: str):
...
def get_publishers_page_count(repo: AbstractRepository):
